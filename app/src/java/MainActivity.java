...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerView mRVSite;
    private AdapterSite mAdapter;
    SwipeRefreshLayout swipeRef;
    Handler handler = new Handler();
    int apiDelayed = 65 * 1000;
    Runnable runnable;
    private Dialog mDialog;
    private Dialog pdLoad;
    ...
    public class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                mRVSite = findViewById(R.id.siteList);
                mAdapter = new AdapterSite(MainActivity.this, data);
                mRVSite.setLayoutManager(new LinearLayoutManager(MainActivity.this));
                mRVSite.setHasFixedSize(true);
                mRVSite.setAdapter(mAdapter);

                ((SimpleItemAnimator) mRVSite.getItemAnimator()).setSupportsChangeAnimations(false);
